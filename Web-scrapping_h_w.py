...
def Web_scrapping():
  ...
  responce = requests.get('https://spb.hh.ru/search/vacancy?text=python%20django%20flask&area=1&area=2/', headers=get_headers())
  ...
  for content_list in main_content_list:
    ...
    company_name_tag = content_list.find('div', class_='vacancy-serp-item__meta-info-company')
    ...
    vacancy_content_tag = vacancy_content.find('div', class_='vacancy-company-redesigned')
